...
<?php if(!empty($videos)) { ?>
	...
	*/ ?>
	...
	<div style="width: 30%;" class="dashboardbox mason">
		...
		Please check out the FAQ or contact the NutriCheck team on<br>Tel: 617 3279 8137<br>or<br>Email: info@nutricheck.com.au, and we will do our best to help you! 
		</div>
	</div>		
