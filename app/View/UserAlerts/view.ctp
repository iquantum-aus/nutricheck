...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit User Alert'), array('action' => 'edit', $userAlert['UserAlert']['id']), array('class' => 'btn')); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete User Alert'), array('action' => 'delete', $userAlert['UserAlert']['id']), array('class' => 'btn'), __('Are you sure you want to delete # %s?', $userAlert['UserAlert']['id'])); ?> </li>
