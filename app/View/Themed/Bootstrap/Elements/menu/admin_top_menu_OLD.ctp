			...
			<div class="nav-collapse collapse">
				...
				*/
				...
				<ul class="nav secondary-nav big">
					...
					<li class="menu"><img src="/img/topmenu_about.jpg" /><a class="fancybox" href="#nutricheckProfile">About</a></li>					
					
					<?php if($group_id == 2) { ?>
						<li class="menu"><img src="/img/topmenu_widgets.jpg" />
					...
					<?php if($group_id != 3) { ?>
						<li class="menu"><img src="/img/topmenu_nutriguide.jpg" />
					...
					<?php if($group_id != 3) { ?>
						<li class="menu"><img src="/img/topmenu_users.jpg" />
					...
					<?php } else if($group_id == 2) { ?>
						<li class="menu"><img src="/img/topmenu_questions.jpg" />
					...
					<?php if($user_info['User']['group_id'] == 2) { ?>						
						<li class="menu"><img src="/img/topmenu_quick.jpg" /><a class="fancybox" href="#quickEntry">Quick Entry</a></li>
						<li><img src="/img/topmenu_print.jpg" /><a target="_blank" href="/questions/print_question_list">Print Question List</a></li>
					<?php } ?>			
					
					<li class="menu"><img src="/img/topmenu_dashboard.jpg" /><?php echo $this->Html->link('Dashboard', '/users/dashboard');?></li>
				</ul>
