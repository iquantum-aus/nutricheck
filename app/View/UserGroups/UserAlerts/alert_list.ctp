<div class="userAlerts index">
	...
	<tr>
		...
		<td>
			...
			<?php 
				if($userAlert['UserAlert']['status'] != 0) {
					echo $this->Html->link(__('Edit'), array('action' => 'edit', $userAlert['UserAlert']['id']), array('class' => 'btn btn-warning')); 
				}
			?>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New User Alert'), array('action' => 'add', $user_id), array('class' => 'btn')); ?></li>
