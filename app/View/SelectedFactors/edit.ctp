...
<?php echo $this->Form->create('SelectedFactor'); ?>
	<fieldset>
		<legend><?php echo __('Edit Selected Factor'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SelectedFactor.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SelectedFactor.id'))); ?></li>
